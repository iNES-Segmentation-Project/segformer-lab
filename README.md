...
FPN이 MLP 대비 val +0.0257, test +0.0147 향상.
두 단계에서 일관된 우위로 신뢰도가 높다.
...
E0~E4의 val-test 하락폭(평균 0.077)은 369개 학습 데이터로 11개 클래스를 scratch 학습하는
조건에서 비롯된 구조적 한계이며, 단일 변수 변경만으로는 해소되지 않는다.
